...
Source-text background that every translation needs (real public figures, recurring characters, author-coined terms and their meanings, sensitive references, easily-mistaken facts) now lives in `/scripts/languages/Translation Guide/prompt.md`. This file holds only the Chinese-version review rules.
